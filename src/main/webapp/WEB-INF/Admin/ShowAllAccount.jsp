            ...
            <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                ...
                <div class="dropdown pb-4">
                    <a href="#" class="d-flex align-items-center text-white text-decoration-none dropdown-toggle" id="dropdownUser1" data-bs-toggle="dropdown" aria-expanded="false">
                        <img src="img/Marshall-Logo-1-2048x768.png" alt="hugenerd" width="30" height="30" style="background-color: white;object-fit: container;" class="rounded-circle">
			...
			<tbody>
				<c:forEach items="${Acc}" var="Acc">
			        <tr>
			            ...
			            <td>${Acc.password}</td>
			            <td><img src="img/${Acc.imgUser}"/></td>
			            <td>${Acc.role_id}</td>
			            <td><a class="btn btn-primary" href="UpdateAcc?id=${Acc.id_Account}">Edit</a></td>
						<td><a class="btn btn-danger" href="DeleteAcc?id=${Acc.id_Account}">Delete</a></td>
			        </tr>
				</c:forEach>
			</tbody>
		</table>
